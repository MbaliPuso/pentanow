...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/4f72b40b-7060-4b9f-847f-d389ad0675a9.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/fbb21e48-3cff-4f40-af37-8e77f314ea80.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/47fc93f1-77e1-4fb3-a340-2ee8fb32fc40.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/65d6a34e-0860-45f4-89be-65ffe0f5f727.jpg?"
    ];
...
<script>
  ...
  function showImage(index) {
        ...
        img.classList.remove('active');
                                 ...
                                 <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">Renault</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
                                            <div class="text-muted">Model</div>
                                            <strong>Triber</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
    ...
    <div id="appCapsule tohalf" class="tohalf">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">Renualt - Triber</h4>
                                   <div>
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 209 800.00</h2>
        ...
        <input type="hidden" name="brand" value="Renualt - Triber">

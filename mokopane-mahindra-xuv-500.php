...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/91c4b960-d6ce-4133-89eb-5284193f10f2.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/02b1f64a-340d-4002-a893-e8494d9ac6f3.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/b43fa278-ed09-463c-9f96-7f3d5e68f46b.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/4f9ceba8-7827-48cc-b4e0-44b19b9d7b1a.jpg?"
    ];
        ...
        img.classList.remove('active');
                                 ...
                                 <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">MAHINDRA</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
                                            <div class="text-muted">Model</div>
                                            <strong>The Stylish New XUV 500</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">MAHINDRA - The Stylish New XUV 500</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>16 421Km</p>
                                        </div>
                                        <div> 
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 329 900.00</h2>
                                   </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <ul class="listview flush transparent no-line image-listview detailed-list mt-1 mb-1" style="padding:10px">
                    ...
                    <form id="enquiryForm">
                        ...
                        <input type="hidden" name="brand" value="MAHINDRA - The Stylish New XUV 500">

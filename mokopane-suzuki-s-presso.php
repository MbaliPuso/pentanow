...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/718cddaa-305e-4581-ae16-853456552fbb.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/ae4d802c-9f83-4699-afaf-63c5281710c3.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/6345589e-49ea-42f8-965a-a3841715e983.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/60d6e502-a51e-40c2-8812-004146f860b0.jpg?"
    ];
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">Suzuki S.Presso</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>37 670Km</p>
                                        </div>
                                        <div> 
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 155 900.00</h2>
                                   </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <ul class="listview flush transparent no-line image-listview detailed-list mt-1 mb-1" style="padding:10px">
                    ...
                    <form id="enquiryForm">
                        ...
                        <input type="hidden" name="brand" value="Suzuki S.Presso">

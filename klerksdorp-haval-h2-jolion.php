...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/27d28975-4df9-4553-a5a9-a1953129a080.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/e6f305fd-ea33-44a3-880d-dc544a4afa7d.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/4bf29f2f-99aa-4a72-aa75-8b4c324b9aea.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/d69854d0-2b95-4498-9eea-c1405ec78f95.jpg?"
    ];
...
<script>
  ...
  function showImage(index) {
                                 ...
                                 <!-- Gallery Image End-->
                                    ...
                                    <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">Haval</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
                                            <div class="text-muted">Model</div>
                                            <strong>H2 Jolion</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
    ...
    <div id="appCapsule tohalf" class="tohalf">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                <!-- Listing Image-->
                                    ...
                                    <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">Haval - H2 Jolion</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>25 585km</p>
                                        </div>
                                        <div> 
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 259 800.00</h2>
        ...
        <input type="hidden" name="brand" value="Haval - H2 Jolion">

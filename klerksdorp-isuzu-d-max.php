...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/7be3e990-26a4-4beb-b935-04480f848555.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/358e5f77-0d3a-45e0-be64-65a37a3f6191.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/91c8da48-3f18-429e-8dec-7f5a4b06de04.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/b5868924-ccc1-43c9-8cd5-9d3ea3c71fba.jpg?"
    ];
...
<script>
  ...
  function showImage(index) {
        ...
        img.classList.remove('active');
                                 ...
                                 <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">Isuzu</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
    ...
    <div id="appCapsule tohalf" class="tohalf">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">Isuzu - D-MAX</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>108 689Km</p>
                                        </div>
                                        <div> 
        ...
        <input type="hidden" name="brand" value="Isuzu - D-MAX">

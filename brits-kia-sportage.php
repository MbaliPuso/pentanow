...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/e97c2a67-c870-48bb-b3f9-1d53299c9366.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/e0f8f6e4-dab5-4002-abb0-6e0b1a807c16.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/ef28b57a-fc4c-4e1a-9161-b35cd93c6a1b.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/104be74c-6e9a-470b-8075-7e30693054eb.jpg?"
    ];
...
<script>
  ...
  function showImage(index) {
        ...
        img.classList.remove('active');
                                 ...
                                 <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">KIA</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
    ...
    <div id="appCapsule tohalf" class="tohalf">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">KIA - SPORTAGE</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>96 800Km</p>
                                        </div>
                                        <div> 
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 299 900.00</h2>
                                   </div>
                            </div>
                        </div>
                    </div>
        ...
        <input type="hidden" name="brand" value="KIA - Sportage">

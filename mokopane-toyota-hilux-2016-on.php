...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/64c9226a-80b4-4aa8-8424-cf593a1d1cce.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/a5a7de49-4c82-4abb-834b-ef84ea0ea011.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/824f8ba3-da18-4304-8182-772f4bff210e.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/708fb3d9-06e3-481b-a326-fe8a37f3543c.jpg?"
    ];
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">Toyota - Hilux 2016 ON</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>69 188Km</p>
                                        </div>
                                        <div> 
                                    ...
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 389 900.00</h2>
                                   </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <ul class="listview flush transparent no-line image-listview detailed-list mt-1 mb-1" style="padding:10px">
                    ...
                    <form id="enquiryForm">
                        ...
                        <input type="hidden" name="brand" value="Toyota - Hilux 2016 ON">

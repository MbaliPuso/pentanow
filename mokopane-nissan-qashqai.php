...
<head>
    ...
    <title>Penta Now | Mokopane</title>
    <meta name="keywords" 
...
<div class="toflexflex">
  ...
  <div class="showing">
    ...
    // Array of image URLs
    $images = [
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/9614b163-ee7d-47fa-a78d-ccc3d8c16b62.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/63ced85d-7a8b-4fd0-9297-7a4069aa850b.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/c7d72645-680a-40f0-a0be-3ea760a008bd.jpg?",
      "https://san-cdn.pinewooddms.com/99f5b996-9f70-47fb-84b2-f682d61be218/vehicles/4692242a-29af-49eb-aab7-722e86230189.jpg?"
    ];
...
<script>
  ...
  function showImage(index) {
        ...
        img.classList.remove('active');
                                 ...
                                 <ul class="listview no-line transparent flush simple-listview">
                                        <li style="padding: 0px 0px;">
                                            ...
                                            <strong class="text-success">NISSAN</strong>
                                        </li>
                                        <li style="padding: 0px 0px;">
    ...
    <div id="appCapsule tohalf" class="tohalf">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="background: #fff;margin: 0px 8px;border-radius: 10px;">
                            <div class=" pb-0"class="change">
                                ...
                                <h4 style="color:#222222;font-size: 25px;margin-bottom: 15px !important; margin-top:30px;">NISSAN - Qashqai</h4>
                                   <div>
                                    
                                    <div style="display:flex;gap:20px;padding:10px 0px;">
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="speedometer-outline"></ion-icon>51 568Km</p>
                                        </div>
                                        <div> 
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="cog-outline"></ion-icon>CVT</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <p style="font-size:10px;margin-top:-10px;font-size: 14px;"><ion-icon name="location-outline"></ion-icon>Mokopane</p>
                                        </div>
                                    </div>
                                   
                                    <h2 style="color:#222222;margin: 5px 0px 5px 0px;font-size: 35px !important;margin-top: -10px;color:#007bff;font-weight:700;">R 339 000.00</h2>
                                   </div>
                            </div>
                        </div>
                    </div>
        ...
        <input type="hidden" name="brand" value="NISSAN - Qashqai">
        <input type="hidden" name="source" value="Landing page">
        <input type="hidden" name="branch" value="Mokopane">
